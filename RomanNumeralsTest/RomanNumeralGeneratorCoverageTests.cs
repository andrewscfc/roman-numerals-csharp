...
namespace RomanNumeralsTest
{
    ...
    /// </summary>
    [TestFixture]
    public class RomanNumeralGeneratorCoverageTests
    {
        ...
        public static (int unitPortion, string numeralPortion)[] Units = {
            (0, string.Empty),
            (1, "I"),
            (2, "II"),
            (3, "III"),
        ...
        public static (int tenPortion, string numeralPortion)[] Tens = {
            (0, string.Empty),
            (10, "X"),
            (20, "XX"),
            (30, "XXX"),
        ...
        public static (int hundredPortion, string numeralPortion)[] Hundreds = {
            (0, string.Empty),
            (100, "C"),
            (200, "CC"),
            (300, "CCC"),
        ...
        public static (int thousandPortion, string numeralPortion)[] Thousands = {
            (0, string.Empty),
            (1000, "M"),
            (2000, "MM"),
            (3000, "MMM")
            ...
            )
        {
            ...
            if(testValue == 0)
            {
                Assert.Inconclusive("Skip test for zero, covered by other tests");
            }
